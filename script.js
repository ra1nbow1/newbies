var ZoomGrid = (function() {
	...
	var bindActions = function() {
		...
		$(document).on('keyup',function(evt) { if (evt.keyCode == 27) { zoomout() } }); // escape for zoom out
		nextBtn.on('click', nextPost);
		$(document).on('keyup',function(evt) { if (evt.keyCode == 39) { nextPost() } }); // right arrow for next post
	};
